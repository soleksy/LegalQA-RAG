...
class QuestionIndex(Index):
    ...
    def _get_filename_index(self, domains: list[dict]) -> str:
        '''
    ...
    def _get_filename_data(self, domains: list[dict]) -> str:
        '''
    ...
    def _find_missing_nros(self, nro_list: list[int] , domains: list[dict] , batch_size) -> bool:
        '''
    ...
    def _update_raw_questions_index(self, nro_list: list[int] , domains: list[dict]) -> None:
        '''
    ...
    def _update_raw_questions_data(self, questions: list[dict] , domains: list[dict]) -> None:
        '''
    ...
    def _validate_index(self, domains: list[dict]) -> bool:
        '''
